...
def main():
    ...
    parser.add_argument("--train_rate", type=float, default=0.8,  help="訓練データの割合")
    parser.add_argument("--patience",   type=int,   default=10,   help="Early stopping の patience")
    ...
    train_loader, val_loader, test_loader = get_data_loaders(args.batch_size, args.train_rate)
    ...
    if args.z_dim == 2:
        ...
        print("  ヒント: t-SNE や PCA で潜在空間を2次元に落として可視化してみよう（発展課題）。")
